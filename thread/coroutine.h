...
public:
     ...
     * dass der Stackpointer initial auf tos zeigt und bei der ersten Aktivierung
     * die Ausführung mit der Funktion kickoff beginnt.
     * @param tos
     */
    Coroutine(void *tos);
     ...
     * Die aktuelle Belegung der nicht-flüchtigen Register wird in dem toc Element gesichert und
     * durch die Werte von next (dem toc Element der nächsten Koroutine) ersetzt.
     * @param next
     */
     ...
     * Da jedoch nicht alle Koroutinen im System dasselbe tun sollen,
